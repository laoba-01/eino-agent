...
// 已弃用：请使用 SaveContextRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 SaveContextResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 GetContextRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 GetContextResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 DeleteContextRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 DeleteContextResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 UpdateContextRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 UpdateContextResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 SaveVectorRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 VectorData.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 SaveVectorResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 SearchSimilarRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 SearchSimilarResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 SearchResult.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 DeleteVectorRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 DeleteVectorResponse.ProtoReflect.Descriptor 代替。
