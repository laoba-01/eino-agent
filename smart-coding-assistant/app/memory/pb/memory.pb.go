...
type SaveContextRequest struct {
	...
	ExpectedVersion int64                  `protobuf:"varint,4,opt,name=expected_version,json=expectedVersion,proto3" json:"expected_version,omitempty"` // 乐观锁：期望的版本号，0=无条件写入
...
func (x *SaveContextRequest) GetExpectedVersion() int64 {
	if x != nil {
...
type SaveContextResponse struct {
	...
	NewVersion     int64                  `protobuf:"varint,3,opt,name=new_version,json=newVersion,proto3" json:"new_version,omitempty"`             // 写入成功后的新版本号
	CurrentVersion int64                  `protobuf:"varint,4,opt,name=current_version,json=currentVersion,proto3" json:"current_version,omitempty"` // 冲突时返回当前版本号（error="VERSION_CONFLICT"）
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SaveContextResponse) GetNewVersion() int64 {
	if x != nil {
		return x.NewVersion
	}
	return 0
...
func (x *SaveContextResponse) GetCurrentVersion() int64 {
	if x != nil {
...
type GetContextResponse struct {
	...
	Version       int64                  `protobuf:"varint,4,opt,name=version,proto3" json:"version,omitempty"` // 当前数据版本号（用于后续 CAS 写入）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetContextResponse) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
type DeleteContextRequest struct {
	...
	UserId          string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	Keys            []string               `protobuf:"bytes,2,rep,name=keys,proto3" json:"keys,omitempty"`
	ExpectedVersion int64                  `protobuf:"varint,3,opt,name=expected_version,json=expectedVersion,proto3" json:"expected_version,omitempty"` // 乐观锁：期望的版本号，0=无条件删除
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *DeleteContextRequest) GetExpectedVersion() int64 {
	if x != nil {
		return x.ExpectedVersion
	}
	return 0
...
type DeleteContextResponse struct {
	...
	Success        bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Error          string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	CurrentVersion int64                  `protobuf:"varint,3,opt,name=current_version,json=currentVersion,proto3" json:"current_version,omitempty"` // 冲突时返回当前版本号
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *DeleteContextResponse) GetCurrentVersion() int64 {
	if x != nil {
		return x.CurrentVersion
	}
	return 0
...
func (x *UpdateContextRequest) GetExpectedVersion() int64 {
	if x != nil {
		return x.ExpectedVersion
	}
	return 0
...
func (x *UpdateContextResponse) GetNewVersion() int64 {
	if x != nil {
		return x.NewVersion
	}
	return 0
...
func (x *UpdateContextResponse) GetCurrentVersion() int64 {
	if x != nil {
		return x.CurrentVersion
	}
	return 0
...
const file_app_memory_memory_proto_rawDesc = "" +
	"\n" +
	"\x17app/memory/memory.proto\x12\x06memory\"\xe9\x01\n" +
	...
	"newVersion\x12'\n" +
	"\x0fcurrent_version\x18\x04 \x01(\x03R\x0ecurrentVersion\"@\n" +
	"\x11GetContextRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
	"\x04keys\x18\x02 \x03(\tR\x04keys\"\xdd\x01\n" +
	...
	"\aversion\x18\x04 \x01(\x03R\aversion\x1a:\n" +
	"\fContextEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x0fcurrent_version\x18\x03 \x01(\x03R\x0ecurrentVersion\"\xed\x01\n" +
	...
	"\vnew_version\x18\x03 \x01(\x03R\n" +
	"newVersion\x12'\n" +
	"\x0fcurrent_version\x18\x04 \x01(\x03R\x0ecurrentVersion\"a\n" +
