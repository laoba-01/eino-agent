...
// 已弃用：请使用 ChatRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 ChatResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 GetHistoryRequest.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 GetHistoryResponse.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 ChatMessage.ProtoReflect.Descriptor 代替。
