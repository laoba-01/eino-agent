...
func (x *AnalyzeCodeErrorRequest) Reset() {
	*x = AnalyzeCodeErrorRequest{}
	mi := &file_protos_tool_service_proto_msgTypes[0]
...
func (*AnalyzeCodeErrorRequest) Descriptor() ([]byte, []int) {
	return file_protos_tool_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AnalyzeCodeErrorResponse) Reset() {
	*x = AnalyzeCodeErrorResponse{}
	mi := &file_protos_tool_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyzeCodeErrorResponse) Descriptor() ([]byte, []int) {
	return file_protos_tool_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *QuerySyntaxRequest) Reset() {
	*x = QuerySyntaxRequest{}
	mi := &file_protos_tool_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*QuerySyntaxRequest) Descriptor() ([]byte, []int) {
	return file_protos_tool_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *QuerySyntaxResponse) Reset() {
	*x = QuerySyntaxResponse{}
	mi := &file_protos_tool_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*QuerySyntaxResponse) Descriptor() ([]byte, []int) {
	return file_protos_tool_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *GenerateProblemSolutionRequest) Reset() {
	*x = GenerateProblemSolutionRequest{}
	mi := &file_protos_tool_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateProblemSolutionRequest) Descriptor() ([]byte, []int) {
	return file_protos_tool_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *GenerateProblemSolutionResponse) Reset() {
	*x = GenerateProblemSolutionResponse{}
	mi := &file_protos_tool_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateProblemSolutionResponse) Descriptor() ([]byte, []int) {
	return file_protos_tool_service_proto_rawDescGZIP(), []int{5}
}
...
var File_protos_tool_service_proto protoreflect.FileDescriptor

const file_protos_tool_service_proto_rawDesc = "" +
	"\n" +
	"\x19protos/tool_service.proto\x12\x04tool\"n\n" +
	...
	"\x17GenerateProblemSolution\x12$.tool.GenerateProblemSolutionRequest\x1a%.tool.GenerateProblemSolutionResponseB\tZ\a./protob\x06proto3"

var (
	file_protos_tool_service_proto_rawDescOnce sync.Once
	file_protos_tool_service_proto_rawDescData []byte
)

func file_protos_tool_service_proto_rawDescGZIP() []byte {
	file_protos_tool_service_proto_rawDescOnce.Do(func() {
		file_protos_tool_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protos_tool_service_proto_rawDesc), len(file_protos_tool_service_proto_rawDesc)))
	})
	return file_protos_tool_service_proto_rawDescData
}

var file_protos_tool_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_protos_tool_service_proto_goTypes = []any{
...
var file_protos_tool_service_proto_depIdxs = []int32{
	0, // 0: tool.ToolService.AnalyzeCodeError:输入类型 -> tool.AnalyzeCodeErrorRequest
	2, // 1: tool.ToolService.QuerySyntax:输入类型 -> tool.QuerySyntaxRequest
	4, // 2: tool.ToolService.GenerateProblemSolution:输入类型 -> tool.GenerateProblemSolutionRequest
	1, // 3: tool.ToolService.AnalyzeCodeError:输出类型 -> tool.AnalyzeCodeErrorResponse
	3, // 4: tool.ToolService.QuerySyntax:输出类型 -> tool.QuerySyntaxResponse
	5, // 5: tool.ToolService.GenerateProblemSolution:输出类型 -> tool.GenerateProblemSolutionResponse
	3, // [3:6] 是方法输出类型的子列表
	0, // [0:3] 是方法输入类型的子列表
	0, // [0:0] 是扩展类型名称的子列表
	0, // [0:0] 是扩展目标的子列表
...
func init() { file_protos_tool_service_proto_init() }
func file_protos_tool_service_proto_init() {
	if File_protos_tool_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protos_tool_service_proto_rawDesc), len(file_protos_tool_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_protos_tool_service_proto_goTypes,
		DependencyIndexes: file_protos_tool_service_proto_depIdxs,
		MessageInfos:      file_protos_tool_service_proto_msgTypes,
	}.Build()
	File_protos_tool_service_proto = out.File
	file_protos_tool_service_proto_goTypes = nil
	file_protos_tool_service_proto_depIdxs = nil
}
